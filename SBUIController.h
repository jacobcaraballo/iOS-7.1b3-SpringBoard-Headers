...
@class NSString, SBAppSliderWindowController, SBWindow, SBDismissOnlyAlertItem, SBAppSliderController, UIStatusBar, NSArray, SBSwitchAppGestureView, NSMutableDictionary, NSMutableSet, SBAnimationStepper, UIView, NSMutableArray, SBApplication, SBWorkspaceEventQueueLockAssertion;
