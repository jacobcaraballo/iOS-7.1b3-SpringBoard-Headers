...
@class SBLockScreenView, NSMutableSet, SBLockScreenHintLongPressGestureRecognizer, SBLockScreenHintPanGestureRecognizer, SBLockScreenHintTapGestureRecognizer, NSDate, NSMapTable;
