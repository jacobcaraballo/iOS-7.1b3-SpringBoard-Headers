...
@class NSObject, SBWorkspaceTransaction, NSTimer, BKSWorkspace, SBScreenTimeTrackingController, NSMutableArray, SBAlertManager, SBWorkspaceEventQueueLockAssertion;
