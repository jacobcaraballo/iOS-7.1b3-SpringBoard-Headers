...
@class NSObject, NSSet, BBDataProviderConnection, NSHashTable, SBUIController, UIWindow, NSMutableSet, NSTimer, NSMutableArray, SBApplication, NSNumberFormatter, NSDate, SBCardItemsController;
